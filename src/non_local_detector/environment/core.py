...
class LinearAdapter:
    ...
    def to_linear(self, bin_indices: IdxArr) -> PtArr:
        ...
        ------
        AttributeError
            If the underlying 1D mapping function (`_lin`) is not available.
        """
    ...
    def to_bin(self, linear_points: PtArr) -> IdxArr:
        ...
        ------
        AttributeError
            If the underlying 1D mapping function (`_lin_to_nd`) is not available.
        """
    ...
    def to_linear_cont(self, points: PtArr) -> PtArr:
        ...
        ------
        AttributeError
            If the continuous projection function (`_nd_points_to_linear_func_`)
            is not available.
        """
    ...
    def plot(self, ax: Optional[MatplotlibAxes] = None, **kw: Any) -> MatplotlibAxes:
        ...
        **kw : Any
        ...
        ------
        AttributeError
            If the 1D plotting function (`_plot_1d`) is not available.
        """
